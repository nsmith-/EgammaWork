...
// Class:      ElectronNtuplerTNPStudy
// 
/**\class ElectronNtuplerTNPStudy ElectronNtuplerTNPStudy.cc EgammaWork/ElectronNtupler/plugins/ElectronNtuplerTNPStudy.cc
...
class ElectronNtuplerTNPStudy : public edm::EDAnalyzer {
public:
  explicit ElectronNtuplerTNPStudy(const edm::ParameterSet&);
  ~ElectronNtuplerTNPStudy();
  
  static void fillDescriptions(edm::ConfigurationDescriptions& descriptions);
  
  enum ElectronMatchType {NOT_MC_SAMPLE = -1,
                          UNMATCHED = 0, 
...
private:
  ...
  edm::EDGetTokenT<pat::METCollection> metMiniAODToken_;
...
//
ElectronNtuplerTNPStudy::ElectronNtuplerTNPStudy(const edm::ParameterSet& iConfig):
  ...
  verboseIdFlag_(iConfig.getParameter<bool>("eleIdVerbose"))
{
  ...
  metToken_ = mayConsume< reco::METCollection >
    (iConfig.getParameter<edm::InputTag>
     ("met"));
  ...
  metMiniAODToken_ = mayConsume< pat::METCollection >
    (iConfig.getParameter<edm::InputTag>
     ("metMiniAOD"));
  ...
  electronTree_->Branch("metPt",  &metPt_ , "metPt/F");
  electronTree_->Branch("metPhi",  &metPhi_ , "metPhi/F");

  electronTree_->Branch("pt"  ,  &pt_    );
  electronTree_->Branch("eta" ,  &eta_ );
  electronTree_->Branch("phi" ,  &phi_ );
  electronTree_->Branch("q"   ,  &q_);
...
ElectronNtuplerTNPStudy::~ElectronNtuplerTNPStudy()
{
...
void
ElectronNtuplerTNPStudy::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  using namespace std;
  using namespace edm;
  ...
  if( isAOD ){
    ...
    iEvent.getByToken(metMiniAODToken_, mets);
  ...
  for (size_t i = 0; i < electrons->size(); ++i){
    ...
    if( !isData ){
      ...
      isTrue_.push_back( NOT_MC_SAMPLE );
    }
...
void 
ElectronNtuplerTNPStudy::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
ElectronNtuplerTNPStudy::endJob() 
{
}
...
/*
void 
ElectronNtuplerTNPStudy::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
ElectronNtuplerTNPStudy::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
ElectronNtuplerTNPStudy::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void 
ElectronNtuplerTNPStudy::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
ElectronNtuplerTNPStudy::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
int ElectronNtuplerTNPStudy::matchToTruth(const edm::Ptr<reco::GsfElectron> el, 
...
void ElectronNtuplerTNPStudy::findFirstNonElectronMother(const reco::Candidate *particle,
						 int &ancestorPID, int &ancestorStatus){
...
void ElectronNtuplerTNPStudy::printCutFlowResult(vid::CutFlowResult &cutflow){
...
DEFINE_FWK_MODULE(ElectronNtuplerTNPStudy);
