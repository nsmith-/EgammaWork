...
process.ntupler = cms.EDAnalyzer(
    ...
    phoMediumIdBoolMap = cms.InputTag("egmPhotonIDs:mvaPhoID-PHYS14-PU20bx25-nonTrig-V1-wp90"),
    phoMediumIdFullInfoMap = cms.InputTag("egmPhotonIDs:mvaPhoID-PHYS14-PU20bx25-nonTrig-V1-wp90"),
    ...
    #
    mvaValuesMap     = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Phys14NonTrig25nsV1Values"),
    mvaCategoriesMap = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Phys14NonTrig25nsV1Categories")
    )
