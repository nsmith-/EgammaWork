...
process.ntupler = cms.EDAnalyzer('PhotonNtuplerVIDwithMVADemo',
                                 ...
                                 #
                                 phoMediumIdMap = cms.InputTag("egmPhotonIDs:mvaPhoID-PHYS14-PU20bx25-nonTrig-V1-wp90"),
                                 #
                                 # ValueMaps with MVA results
                                 #
                                 mvaValuesMap     = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Phys14NonTrigValues"),
                                 mvaCategoriesMap = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRun2Phys14NonTrigCategories")
                                )
